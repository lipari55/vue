    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="静态属性" name="only">
          <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="adddialogVisible">添加属性</el-button>
          <!-- 添加静态参数的面板 -->
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 让文本框自动获得焦点
      // nextTick方法作用 当页面上元素重新被渲染之后 才会执行回调函数中的代码
      this.$nextTick(_ => {
